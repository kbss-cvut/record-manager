...
public class InstitutionController extends BaseController {
    ...
    @PreAuthorize("hasAuthority('" + SecurityConstants.adminInstitution + "')")
    ...
    @PreAuthorize("hasAuthority('" + SecurityConstants.adminInstitution + "') or @securityUtils.isMemberOfInstitution(#key)")
    ...
    @PreAuthorize("hasAuthority('" + SecurityConstants.adminInstitution + "') or @securityUtils.isRecordInUsersInstitution(#key)")
